...
public class menu_procurement_information extends  com.example.main.main_menu_template  implements AdapterView.OnItemSelectedListener, customButtonListener2,customButtonListener, customEditextfocusListener  {
        String menu_makan []={"daging ayam","daging ikan","daging sapi","daging ayam","daging ikan","daging sapi"};
    String stock []={"01","02","03","04","05","06"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View child = getLayoutInflater().inflate(R.layout.menu_procurement_information, null);
        item.addView(child);
...
*/
      ...
      //  listView.setAdapter(adapter);
        ...
        adapter4 = new ListAdapter(menu_procurement_information.this,dataItems   );
        variabelpublic.Data_id=dataItems2;

        adapter4.setCustomButtonListner(menu_procurement_information.this);
        adapter4.setCustomButtonListner2(menu_procurement_information.this) ;
                adapter4.setCustomEditextfocus(menu_procurement_information.this); ;
    ...
    public void onButtonClickListner2(int position, String value) {
        Toast.makeText(menu_procurement_information.this, "rrrrrrrrr "  , Toast.LENGTH_LONG).show();
        Log.i("ts","tr");
    }
