...
import procurement.menu_procurement_download;
import procurement.menu_procurement_information;
import procurement.menu_procurement_request;


public class menu_meals extends com.example.main.main_menu_template {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View child = getLayoutInflater().inflate(R.layout.menu_meals, null);
        item.addView(child);
        ...
        button_menu_procurement_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(menu_meals.this,menu_procurement_request.class);
                finish();
                startActivity(i);
        ...
        button_menu_procurement_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(menu_meals.this,menu_procurement_information.class);
                finish();
                startActivity(i);
        ...
        button_menu_procurement_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent i = new Intent(menu_meals.this,menu_procurement_download.class);
                finish();
                startActivity(i);
